...
class MainWindow(View):
    ...
    def _create_entries(self):
        code_entry: Entry = Entry(self)
        code_entry.place(x=150, y=100, width=200, height=30)

        description_entry: Entry = Entry(self)
        description_entry.place(x=150, y=160, width=200, height=30)

        price_entry: Entry = Entry(self)
        price_entry.place(x=150, y=220, width=200, height=30)
    ...
    def _create_register_button(self):
        register_button: Button = Button(self, text='Cadastrar', font='arial', command=self.controller.register)
